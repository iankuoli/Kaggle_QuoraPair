...
from seqWGAN.Wgenerator import WGenerator

from seqWGAN.dataloader import Gen_Data_loader, Dis_dataloader
from seqWGAN.Wdiscriminator import WDiscriminator
...
def main():
    ...
    # ----------------------------------------------------------------------------
    # declare: generator
    generator = WGenerator(vocab_size, BATCH_SIZE, EMB_DIM, HIDDEN_DIM, SEQ_LENGTH, START_TOKEN)

    # declare: discriminator
    discriminator = WDiscriminator(sequence_length=20, num_classes=2,
                                   vocab_size=vocab_size, embedding_size=dis_embedding_dim,
                                   filter_sizes=dis_filter_sizes, num_filters=dis_num_filters,
                                   l2_reg_lambda=dis_l2_reg_lambda, optimizer='RMSProp')
    # ----------------------------------------------------------------------------
